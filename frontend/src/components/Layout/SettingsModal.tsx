                        ...
                        <tr key={invite.id} className="hover:bg-surface-alt/30">
                          ...
                          <td className="px-2 py-2">
                            <button
                              ...
                              className="p-1 text-text-muted hover:text-error disabled:opacity-40 transition-colors"
                              title="Delete invite"
                            >
